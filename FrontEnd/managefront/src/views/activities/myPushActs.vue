    ...
    <div id="myPushActs">
      <div>
        ...
        <div v-if="activitityname == ''">
          <el-tag class="top_tag" effect="dark" type="danger">选一个你发布的活动吧！</el-tag>
        </div>
      </div>
      <div v-if="activitityname != ''">
        ...
        <div>
          <el-tag class="middle_tag" effect="dark" type="success" @click="openalready">报名的学生</el-tag>
        </div>
        <div v-if="isalready">
          <el-table
            :data="usersList"
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                ...
                <el-dialog ref="dialog" :close-on-click-modal="false" width="700px"
                           :visible.sync="dialogmanyFormVisible">
