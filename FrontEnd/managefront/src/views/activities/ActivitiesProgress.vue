<template xmlns:c="http://www.w3.org/1999/html">
  <div id="ActivitiesProgress_box">
    <div id="ActivitiesProgress">
      <div v-if="activitityname == ''"><el-tag class="top_tag" effect="dark" type="danger">未查询到数据</el-tag></div>
      ...
      <el-row class="row">
        ...
        <el-row class="row">
          ...
          <el-col :span="9"><div class="grid-content bg-purple-light"><span class="spanText">{{activitityStartTime|dateFormat}}----{{activitityEndTime|dateFormat}}</span></div></el-col>
        <el-col :span="3"><div class="grid-content bg-purple"><span class="span">报名时间:</span></div></el-col>
        <el-col :span="9"><div class="grid-content bg-purple-light"><span class="spanText">{{signuptime|dateFormat}}----{{signupendtime|dateFormat}}</span></div></el-col>
        </el-row>
        <el-row class="row">
